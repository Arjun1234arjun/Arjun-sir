...
const array = ['Kozhi','Arjun','Bye','bye','Dai','Poli','Dance','Gd mrng','Skba','Ara','Poyi','Shadow','myr','Sticker','poda','podi','Pain','girl','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','Bomb','jithin']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
